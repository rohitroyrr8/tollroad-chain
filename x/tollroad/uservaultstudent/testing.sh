...
weights=( "TestUserVaultMsgServerCreateFive:5"
          ...
          "TestUserVaultQuerySingle:0"
          "TestUserVaultQuerySingle/First:1"
          "TestUserVaultQuerySingle/Second:1"
          "TestUserVaultQuerySingle/KeyNotFound:1"
          "TestUserVaultQuerySingle/InvalidRequest:0"
...
if [[ $buildfailed -ge 1 ]];
then
    echo UserVault student fail score $totalWeights / $totalWeights
    echo UserVault student win score 0 / $totalWeights
    exit $totalWeights
fi
